    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-header text-white p-4 rounded-top-4" style="background-color: #4e73df;">
                ...
                <div class="card-body p-5">
                    <form action="{{ route('lotes.store') }}" method="POST" id="loteForm">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" id="btnSubmit" class="btn btn-primary btn-lg py-3 fw-bold shadow-sm uppercase">
                                🚀 Cargar al Inventario Real
                            </button>
                            <a href="{{ route('admin.dashboard') }}" class="btn btn-link text-secondary text-decoration-none text-center">
                                Cancelar operación
                            </a>
                        </div>
                    </form>
